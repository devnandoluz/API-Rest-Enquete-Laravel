...
<head>
    ...
    <!-- Styles -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frameworks/fontawesome/css/all.css') }}" rel="stylesheet">
    <link href="{{ asset('frameworks/bootstrap/css/bootstrap.css') }}" rel="stylesheet"/>
    <link href="{{ asset('css/home.css') }}" rel="stylesheet"/>
   
    <!-- Customização - Geral do Tema -->
    <script src="{{asset('frameworks/sweetalert/dist/sweetalert2.all.min.js') }}"></script>
    <link href="{{ asset('css/berserker.css') }}" rel="stylesheet"/>
